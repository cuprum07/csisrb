...
module.exports = {
    imgToHtml: function(html,session){
        return new Promise (function(resolve,reject){
            ...
            client.html_to_image('<html><style>body {font-family: arial;}table {border-collapse: collapse; background-color: #fff;} td {border: 1px solid #000;padding: 3px}</style><body>'+html+'</body></html>',optionsImg); 
